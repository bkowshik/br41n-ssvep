...
2. **Filtering on this dataset is mostly cosmetic, not corrective.** Butterworth filters are flat in the passband by construction, so the alpha rhythm sitting on top of 9–12 Hz stimulation frequencies survives filtering untouched. What handles alpha is *features that care about phase* (CCA), not preprocessing.
